...
void test_fourier_from_table() {
  ...
  assertComplexEqual( F.output(0.0), sqrt(pi), 2e-3 );
  assertComplexEqual( F.output(0.5), exp(-0.25 * pi * pi) * sqrt(pi), 2e-3 );
}
